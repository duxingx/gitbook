...
PROC TEMPLATE;
        ...
        REPLACE FONTS/
           ...
           STYLE GRAPHFONTS FROM GRAPHFONTS /
              'GraphTitleFont' = ("Courier New, Courier",9pt)
              'GraphLabelFont' = ("Courier New, Courier",9pt)
              'GraphValueFont' = ("Courier New, Courier",9pt)
              'GraphDataFont'  = ("Courier New, Courier",9pt);

           STYLE SYSTEMTITLE FROM TITLESANDFOOTERS /
              FONT = ("Courier New, Courier",9pt);
